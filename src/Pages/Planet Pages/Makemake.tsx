            ...
            <div className='main2'>
                ...
                <Container>
                    ...
                    <div className='context'>
                        ...
                        <img src="https://assets.science.nasa.gov/dynamicimage/assets/science/psd/solar/internal_resources/5067/Makemake_moon-1.jpeg?w=1536&format=webp&fit=clip&crop=faces%2Cfocalpoint" alt="" />

                        <h1>Namesake</h1>

                        <p>Makemake was named after the Rapanui god of fertility.
                        </p>

                        <h1>Potential for Life</h1>

                        <p>The surface of Makemake is extremely cold, so it seems unlikely that life could exist there.</p>

                        <h1>Size and Distance </h1>

                        <p>With a radius of approximately 444 miles (715 kilometers), Makemake is 1/9 the radius of Earth. If Earth were the size of a nickel, Makemake would be about as big as a mustard seed.
                        ...
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQIeNTQJfJ5BGfe3xlNgFIINNop21xS-X2XVw&s" alt="" />

                        <h1>Orbit and Rotation </h1>

                        <p>Makemake takes 305 Earth years to make one trip around the Sun. As Makemake orbits the Sun, it completes one rotation every 22 and a half hours, making its day length similar to Earth and Mars.</p>

                        <h1>Moons</h1>

                        <p>Makemake has one provisional moon, S/2015 (136472) 1, and it's nicknamed MK 2. It is more than 1,300 times fainter than Makemake. MK 2 was seen approximately 13,000 miles from the dwarf planet, and its radius is estimated to be about 50 miles (80 kilometers).
                        </p>

                        <h1>Rings</h1>
                        <p>There are no known rings around Makemake.</p>
                        ...
                        <p>Scientists know very little about Makemake's structure.</p>
