            ...
            <div className='main2'>
                ...
                <Container>
                    ...
                    <div className='context'>
                        ...
                        <img src="https://lh3.googleusercontent.com/IZjBJXal7ktjzYMFc1VcpQfp41DIGjDLNIHMw_uOSEf8vZuNu6-HNQew4g9LKZE_GRuDf_SY8LIQdSTKxnga-JSQ5w=s1280-w1280-h800" alt="" />

                        <h1>Namesake</h1>

                        <p>The name Earth is at least 1,000 years old. All of the planets, except for Earth, were named after Greek and Roman gods and goddesses. However, the name Earth is a Germanic word, which simply means “the ground.”
                        ...
                        <p>With an equatorial diameter of 7926 miles (12,760 kilometers), Earth is the biggest of the terrestrial planets and the fifth largest planet in our solar system.
                            ...
                            It takes about eight minutes for light from the Sun to reach our planet.</p>
                        ...
                        <p>Earth is the only planet that has a single moon. Our Moon is the brightest and most familiar object in the night sky. In many ways, the Moon is responsible for making Earth such a great home. It stabilizes our planet's wobble, which has made the climate less variable over thousands of years.
                            ...
                            The Moon is an average of 238,855 miles (384,400 kilometers) away from Earth. That means 30 Earth-sized planets could fit in between Earth and its Moon.</p>
