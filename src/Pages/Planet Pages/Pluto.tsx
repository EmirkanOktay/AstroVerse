            ...
            <div className='main2'>
                ...
                <Container>
                    ...
                    <div className='context'>
                        ...
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRWG6dRJuSSfJihG1DqMquI2-J_7oCVNzAyng&s" alt="" />

                        <h1>Introduction </h1>
                        <p>Pluto is a complex and mysterious world with mountains, valleys, plains, craters, and glaciers. It is located in the distant Kuiper Belt.
                        ...
                        <p>
                            ...
                            However, the Greek name "Plouton" (from which the Romans derived their name "Pluto") was also occasionally used as an alternative name for Hades. But Pluto is definitely the Roman spelling."
                        ...
                        <p>The surface of Pluto is extremely cold, so it's unlikely that life could exist there. At such cold temperatures, water, which is vital for life as we know it, is essentially rock-like. Pluto's interior is warmer, however, and some think there could even be an ocean deep inside.</p>

                        <h1>Size and Distance </h1>

                        <p>Pluto has an equatorial diameter of about 1,477 miles (2,377 kilometers). Pluto is about 1/5th the width of Earth.
                        ...
                        <p>Pluto's orbit around the Sun is unusual compared to the planets: it's both elliptical and tilted. Pluto's 248-year-long, oval-shaped orbit can take it as far as 49.3 astronomical units (AU) from the Sun, and as close as 30 AU. (One AU is the mean distance between Earth and the Sun: about 93 million miles or 150 million kilometers.) But on average, Pluto is 3.7 billion miles (5.9 billion kilometers) away from the Sun, or 39 AU.
                            ...
                            One day on Pluto takes about 153 hours. Its axis of rotation is tilted 57 degrees with respect to the plane of its orbit around the Sun, so it spins almost on its side. Pluto also exhibits a retrograde rotation; spinning from east to west like Venus and Uranus.</p>

                        <h1>Moons</h1>

                        <p>Pluto has five known moons: Charon, Nix, Hydra, Kerberos, and Styx. This moon system might have formed by a collision between Pluto and another similar-sized body early in the history of the solar system.
                        ...
                        <h1>Rings</h1>
                        <p>There are no known rings around Pluto.</p>
                        ...
                        <p>Pluto is about two-thirds the diameter of Earth's Moon and probably has a rocky core surrounded by a mantle of water ice. Interesting ices like methane and nitrogen frost coat the surface. Due to its lower density, Pluto's mass is about one-sixth that of Earth's Moon.</p>
